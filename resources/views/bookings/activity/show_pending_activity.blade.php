        ...
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            ...
            <div class="p-6">
                ...
                <div class="mt-6 flex flex-wrap justify-end space-x-2">
                    ...
                    <!-- Back Button -->
                    <a href="{{ route('activity.pending.booking') }}"
        ...
        <div class="relative p-4 w-full max-w-md h-full md:h-auto mx-auto mt-20">
            <div class="relative bg-white rounded-lg shadow">
                <div class="p-6 text-center">
                    ...
                    <form action="{{ route('activity.booking.approve', $booking->booking_id) }}" method="POST">
                        @csrf
                        @method('PUT')
        ...
        <div class="relative p-4 w-full max-w-md h-full md:h-auto mx-auto mt-20">
            <div class="relative bg-white rounded-lg shadow">
                <div class="p-6">
                    ...
                    <form action="{{--{{ route('decline.pending', $booking->booking_id) }}--}}" method="POST">
                        @csrf
                        @method('PUT')

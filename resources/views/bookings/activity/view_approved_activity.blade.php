<x-layout.default>
    ...
    <div class="panel">
        <h1 class="text-3xl font-bold text-gray-800 mb-6">Activity Success Bookings</h1>
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="py-4 px-10 text-center">
                            <div class="flex justify-center space-x-4">
                                <a href="{{ route('activity.approve.payment', $booking->booking_id) }}" class="text-blue-600 hover:text-blue-700">
                                ...
                                <form id="delete-booking-form-{{ $booking->booking_id }}"
                                      action="{{ route('activity.destroy.booking', $booking->booking_id) }}"
                                      method="POST"
                                      class="hidden">
                                    @csrf
                                    @method('DELETE')

                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="py-4 px-6">
                            @if($booking->payment_status == 'Refund')
                                <span class="bg-yellow-100 text-yellow-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded">Refund</span>
                            @elseif($booking->payment_status == 'Refunded')
                                <span class="bg-green-100 text-green-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded">Refunded</span>
                            @else
                        ...
                        <td class="py-4 px-6">
                            ...
                            @elseif($booking->booking_status == 'Cancelled')
                                <span class="bg-yellow-100 text-yellow-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded">Cancelled</span>
                            @else
                                <span class="bg-red-100 text-red-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded">{{ $booking->booking_status }}</span>
                            @endif
                        </td>
                        {{-- <td class="py-4 px-6">
                            <a href="{{--{{ route('cancelCottage.show', $booking->booking_id) }}" class="text-blue-600 hover:underline flex items-center">

            ...
            <div class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg">
                            <p><span class="font-medium">Cottage Name:</span> {{ $booking->pool->cottage_name }}</p>
                            <p><span class="font-medium">Cottage Type:</span> {{ $booking->pool->cottage_type }}</p>
                ...
                <div class="mt-6 flex flex-wrap justify-end space-x-2">
                    ...
                    <!-- Back Button -->
                    <a href="{{ route('cottage.approved.booking') }}"
        ...
        <div class="relative p-4 w-full max-w-md h-full md:h-auto mx-auto mt-20">
            <div class="relative bg-white rounded-lg shadow">
                <div class="p-6 text-center">
                    ...
                    <form action="{{ route('approve.cottage.payment', $booking->booking_id) }}" method="POST">
                        @csrf
                        @method('PUT')

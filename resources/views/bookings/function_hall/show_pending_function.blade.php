            ...
            <div class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg">
                            <p><span class="font-medium">Function Hall Name:</span> {{ $booking->hall->hall_name }}</p>
                            <p><span class="font-medium">Function Hall Type:</span> {{ $booking->hall->hall_type }}</p>
                            <p><span class="font-medium">Description:</span> {{ $booking->pool->description }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-6 flex flex-wrap justify-end space-x-2">
                    <!-- Conditional Approve and Decline Buttons -->
                    ...
                    <!-- Back Button -->
                    <a href="{{ route('function.pending.booking') }}"
        ...
        <div class="relative p-4 w-full max-w-md h-full md:h-auto mx-auto mt-20">
            <div class="relative bg-white rounded-lg shadow">
                <div class="p-6 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500">Are you sure you want to approve this booking?</h3>
                    <form action="{{ route('function.booking.approve', $booking->booking_id) }}" method="POST">
                        @csrf
                        @method('PUT')
        ...
        <div class="relative p-4 w-full max-w-md h-full md:h-auto mx-auto mt-20">
            <div class="relative bg-white rounded-lg shadow">
                <div class="p-6">
                    ...
                    <form action="{{--{{ route('declinePendingCottage.booking', $booking->booking_id) }}--}}" method="POST">
                        @csrf
                        @method('PUT')

<x-layout.default>
    ...
    <div class="panel">
        <h1 class="text-3xl font-bold text-gray-800 mb-6">Success Rooms Bookings</h1>
            ...
            <table class="min-w-full text-sm text-left text-gray-700">
                ...
                @foreach ($bookings as $booking)
                    <tr class="hover:bg-gray-50">
                        ...
                        {{--<td class="py-4 px-6">
                            <a href="--}}{{--{{ route('bookings.show', $booking->booking_id) }}--}}{{--" class="text-blue-600 hover:underline flex items-center">
                                <i class="fas fa-eye mr-1"></i> View
                            </a>
                        </td>--}}
                        <td class="py-4 px-10 text-center">
                            <div class="flex justify-center space-x-4">
                                <a href="{{ route('room.approved.payment', $booking->booking_id) }}"
                                ...
                                <form id="delete-booking-form-{{ $booking->booking_id }}"
                                      action="{{ route('room.approved.delete', $booking->booking_id) }}"
                                      method="POST"
                                      class="hidden">
                                    @csrf
                                    @method('DELETE')

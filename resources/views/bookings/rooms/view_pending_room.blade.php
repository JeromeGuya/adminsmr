<x-layout.default>
    ...
    <div class="panel">
        <h1 class="text-3xl font-bold text-gray-800 mb-6">Pending Bookings</h1>
        ...
        <div class="overflow-x-auto relative shadow-md sm:rounded-lg">
            <table class="min-w-full text-sm text-left text-gray-700">
                ...
                <tr>
                    ...
                    <th scope="col" class="py-3 px-6">Down Payment</th>
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="py-4 px-10 text-center">
                            <div class="flex justify-center space-x-4">
                                <a href="{{ route('room.pending.show', $booking->booking_id) }}"
                                   class="text-blue-600 hover:text-blue-700">
                                    <i class="fas fa-eye h-5 w-5"></i>
                                </a>
                                <a href="{{ route('room.booking.edit', $booking->booking_id) }}"

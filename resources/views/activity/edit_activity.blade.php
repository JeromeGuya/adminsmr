                ...
                <form action="{{ route('activity.update', $activity->activity_id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="activity_description" id="activity_description" rows="4"
                                  class="mt-1 block w-full px-4 py-2 bg-white border border-gray-300 rounded-md
                                         ...
                                         dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500
                                         focus:border-transparent"
                                  placeholder="Detailed description of the activity..." required>{{ old('activity_description', $activity->activity_description) }}</textarea>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="package" id="package"
                               value="{{ old('package', $activity->package) }}"
                               class="mt-1 block w-full px-4 py-2 bg-white border border-gray-300 rounded-md
                                      dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400
                                      dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500
                                      focus:border-transparent"
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="inclusions" id="inclusions" rows="3"
                                  class="mt-1 block w-full px-4 py-2 bg-white border border-gray-300 rounded-md
                                         ...
                                         dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500
                                         focus:border-transparent"
                                  placeholder="List inclusions such as snacks, equipment, etc.">{{ old('inclusions', $activity->inclusions) }}</textarea>
                    </div>

<x-layout.default>
    ...
    <div class="panel">
        <div class="container mx-auto px-4">
            ...
            <div class="overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
                <form action="{{ route('employees.store') }}" method="POST" id="addEmployeeForm" class="space-y-6 max-w-4xl mx-auto p-6">
                    @csrf

                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <!-- First Name Field -->
                        <div>
                            <label for="employee_first_name" class="block text-sm font-medium text-gray-700 dark:text-gray-300">First Name</label>
                            <input type="text" id="employee_first_name" name="employee_first_name" required
                        ...
                        <!-- Last Name Field -->
                        <div>
                            <label for="employee_last_name" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Last Name</label>
                            <input type="text" id="employee_last_name" name="employee_last_name" required
                                   class="mt-2 block w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                                   placeholder="Doe" />
                        </div>
                        ...
                        <!-- Phone Number Field -->
                        <div>
                            <label for="employee_phone" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Phone Number</label>
                        ...
                        <!-- Password Field -->
                        <div class="relative">
                            <label for="employee_password" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Password</label>
                    ...
                    <!-- Submit Button -->
                    <div class="mt-6">
                        <button type="button" data-modal-toggle="addEmployeeModal" data-modal-target="addEmployeeModal"
    ...
    <!-- Modal -->
    <div id="addEmployeeModal" tabindex="-1" class="hidden fixed top-0 left-0 right-0 z-50 w-full h-full p-4 overflow-x-hidden overflow-y-auto md:inset-0">
        <div class="relative w-full h-full max-w-lg md:h-auto">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                <div class="flex justify-end p-2">
                    <button type="button" data-modal-toggle="addEmployeeModal" class="text-gray-400 hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto dark:hover:bg-gray-600 dark:hover:text-white">
                ...
                <div class="px-6 py-6 lg:px-8">
                    <h3 class="mb-4 text-xl font-semibold text-gray-900 dark:text-white">Confirm Employee Creation</h3>
                    <p class="text-gray-500 dark:text-gray-400">Are you sure you want to create this employee? Once confirmed, the action will be completed.</p>
                    <div class="mt-4 space-x-4">
                        <button type="submit" form="addEmployeeForm" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-800">Confirm</button>
                        <button type="button" data-modal-toggle="addEmployeeModal" class="px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700">Cancel</button>
                    </div>
                </div>
            </div>
        </div>

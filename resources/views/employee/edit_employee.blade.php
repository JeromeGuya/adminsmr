<x-layout.default>
                ...
                <form action="{{ route('employees.update', $employee->employee_id) }}" method="POST" id="editEmployeeForm" class="space-y-6 max-w-4xl mx-auto p-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" id="phone_number" name="phone_number" value="{{ old('phone_number', $employee->phone_number) }}" required
                                   class="mt-2 block w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    ...
                    <!-- Submit Button -->
                    <div class="mt-6">
                        <button type="button" data-modal-toggle="editEmployeeModal" data-modal-target="editEmployeeModal"
    ...
    <!-- Modal -->
    <div id="editEmployeeModal" tabindex="-1" class="hidden fixed top-0 left-0 right-0 z-50 w-full h-full p-4 overflow-x-hidden overflow-y-auto md:inset-0">
        <div class="relative w-full h-full max-w-lg md:h-auto">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                <div class="flex justify-end p-2">
                    <button type="button" data-modal-toggle="editEmployeeModal" class="text-gray-400 hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto dark:hover:bg-gray-600 dark:hover:text-white">
                ...
                <div class="px-6 py-6 lg:px-8">
                    ...
                    <p class="text-gray-500 dark:text-gray-400">Are you sure you want to save changes for this employee?</p>
                    <div class="mt-4 space-x-4">
                        <button type="submit" form="editEmployeeForm" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">Confirm</button>
                        <button type="button" data-modal-toggle="editEmployeeModal" class="px-4 py-2 bg-gray-300 text-gray-800 rounded-lg hover:bg-gray-400">Cancel</button>
                    </div>
                </div>
            </div>
        </div>

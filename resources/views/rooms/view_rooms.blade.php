                    ...
                    @forelse ($rooms as $room)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">
                                <span class="block">{{ $room->room_type }}</span>
                                <span class="text-sm text-gray-500 dark:text-gray-400">{{ $room->name }}</span>
                            </td>
                            <td class="px-6 py-4">
                                PHP{{ number_format($room->rate, 2) }}
                            </td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4 flex space-x-4">
                                ...
                                <button type="button" class="text-red-600 hover:underline dark:text-red-400"
                                        data-modal-toggle="deleteRoomModal-{{ $room->room_id }}"
                                        data-modal-target="deleteRoomModal-{{ $room->room_id }}">
                                    Delete
                                </button>

                                <!-- Modal for Delete Confirmation -->
                                <div id="deleteRoomModal-{{ $room->room_id }}" tabindex="-1"
                                        ...
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                                            ...
                                            <div class="p-6 text-center">
                                                ...
                                                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                                                    Are you sure you want to delete {{ $room->room_name }}? This action
                                                    cannot be undone.
                                                </h3>
